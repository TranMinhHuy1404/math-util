...
//biến class chứa code của mình thành 1 member/implement
...
public class MathUtilDDTTest {
    ...
    //hỗ trợ kết nối luôn file .csv, table trong db, file trong Excel luôn
    ...
    //có bộ data r, ta trích từng cặp ra và test như cách xanh đỏ
    
    @Parameter(value = 0) //gắn biến này vs cột 0
    public int input; //n, ứng cột 0
    
    @Parameter(value = 1) //gắn biến này vs cột 1
    public long expected; //ứng cột 1 giá trị của n!
    
    @Test //trích xuất data đc r, nhồi vào assertEquals
